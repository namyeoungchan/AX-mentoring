...
page('admin',2,'02 / 수업 운영','기록하고 저장한 뒤,<br/>필요한 알림을 보내세요.','출결·팀·과제의 저장 결과는 웹에서 확인합니다. Discord 알림은 별도로 전달됩니다.',
 section('ATTENDANCE','입실·퇴실을 확인하고, 회차를 마감하세요')+
 flow([('회차 시작','과정 · 날짜 · 차시<br/><b>회차 시작</b>'),('입퇴실 안내','Discord 출석 패널<br/>또는 웹 <b>나의 출결</b>'),('등록·예외 확인','입실 · 퇴실 시각 확인<br/>수기 수정은 일괄 저장'),('회차 마감','전체 미처리 0명 확인<br/><b>회차 마감</b>')])+
 note('입실·퇴실을 모두 기록하면 출석 처리됩니다.','명단의 한국시간 입퇴실 시각을 확인하세요. 퇴실 누락·지각·조퇴는 멘토가 확인해 저장합니다. 수기 입력 중에는 자동 갱신을 멈춥니다. 마감 후 정정에는 사유가 필요합니다.')+
...
page('mentor',1,'01 / 참여와 담당 범위','담당 조를 확인하고,<br/>멘토 활동을 시작하세요.','초대받은 아이디로 계정을 만들거나 로그인한 뒤, 초대 수락을 누릅니다.',
 ...
 '<div class="role-comparison"><div><span>메인 강사</span><strong>전체 조</strong><p>회차 시작·마감 및 전체 명단</p></div><div><span>조 담당 멘토</span><strong>배정받은 조</strong><p>담당 조 입퇴실 확인·출결 정정</p></div></div>'+
...
page('mentor',2,'02 / 수업 진행','명단을 빠르게 확인하고,<br/>수업에 집중하세요.','출결·성적·팀 배정은 본인에게 허용된 과정과 담당 조 범위에서 처리합니다.',
 ...
 flow([('회차 확인','과정 · 날짜 · 차시<br/>진행 중인지 확인'),('입실 안내','시작하기 출석 패널<br/>또는 웹 <b>입실</b>'),('퇴실 안내','수업 종료 시 <b>퇴실</b><br/>입퇴실 시각 확인'),('예외·마감 확인','지각·결석 등 수기 저장<br/>전체 처리 후 마감')])+
 '<p class="closing">오늘 진행 중인 회차에만 입퇴실할 수 있습니다. 웹과 Discord는 같은 기록을 사용합니다.</p>'+
 note('누락·예외는 명단에서 정정하세요.','입실만 한 학생은 미처리로 남습니다. 퇴실 누락과 지각·조퇴를 확인해 저장하세요. 학생의 버튼 클릭은 멘토 정정을 덮어쓰지 않습니다. 메인 강사·관리자가 전체 미처리 0명을 확인한 뒤 마감합니다.')+
...
page('mentor',3,'03 / 멘토링과 문제 해결','예약부터 피드백까지,<br/>한 흐름으로 이어가세요.','Discord 인증을 완료하고 멘토링을 받을 수 있는 시간을 먼저 등록하세요.',
 ...
 faq([
 ('회차가 없거나 명단 저장이 충돌해요','관리자에게 오늘 회차 시작을 요청하세요. 저장 충돌은 입력을 보관한 뒤 <b>명단 새로고침</b>으로 학생 입퇴실·다른 멘토의 변경과 대조합니다.'),
...
page('student',3,'03 / 입퇴실과 나의 학습','입실·퇴실을 누르고,<br/>내 기록을 확인하세요.','해당 수업 서버에서 LMS 학생 계정의 Discord 인증을 먼저 완료하세요.',
 section('ATTENDANCE','Discord 패널 또는 웹에서 입실·퇴실')+
 flow([('수업 시작','시작하기 출석 패널<br/>또는 웹에서 <b>입실</b>'),('수업 종료','같은 회차의<br/><b>퇴실</b> 누르기'),('기록 확인','<b>내 입퇴실</b> 또는<br/>웹 <b>나의 출결</b>')])+
 note('입실과 퇴실을 모두 기록해 주세요.','오늘 진행 중인 회차에 한국시간으로 기록됩니다. 웹과 Discord 중 편한 곳에서 누르세요. 중복 클릭은 최초 시각을 유지합니다. 퇴실 누락이나 출결 정정은 멘토에게 요청하세요.')+
 ...
 section('QUICK HELP','막힌 단계부터 확인하세요')+
 faq([
 ('출석 등록이 안 돼요','현재 서버의 LMS 인증·과정 등록과 오늘 회차 시작 여부를 확인하세요. 먼저 입실해야 퇴실할 수 있습니다. 요청이 많다는 안내가 나오면 1분 뒤 다시 시도합니다.'),
 ])+
