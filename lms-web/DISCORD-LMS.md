...
기본안은 공지·질문·과제·멘토링·팀 채팅·팀 음성 채널이며 최대 30개입니다. 기존 서버별 설정이 있다면 처음 기본 구성을 불러올 때 해당 워크스페이스의 최근 설정을 가져옵니다. 기본 구성의 변경은 이후 추가할 서버에 적용합니다. 이미 등록한 서버의 변경은 **저장된 구성**에서 해당 서버를 선택해 편집합니다.
