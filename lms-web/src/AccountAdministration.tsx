...
type Account = { id: string; username: string; name: string; role: string; isSuperAdmin?: boolean; canResetPassword?: boolean; mustChangePassword: boolean; canDelete: boolean; memberships: { role: string; name: string }[] }
