...
export default function App() {
  ...
  if (invitationToken) return <InvitationPage token={invitationToken} account={account} auth={accountExists => <AuthScreen login={login} error={error} enterDemo={enterDemo} registered={refresh} staffInvitation invitationToken={invitationToken} allowSignup={!accountExists} />} logout={logout} accepted={async id => { location.hash = 'dashboard'; await selectWorkspace(id); setInvitationToken('') }} />
