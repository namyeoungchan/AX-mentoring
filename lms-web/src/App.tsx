...
const pageInfo: Record<string, [string, string]> = {
  ...
  'discord-identities': ['Discord 인증 관리', '인증 목록 · 연결 해제 및 고아 기록 정리'],
