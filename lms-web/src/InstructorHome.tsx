...
export default function InstructorHome({ workspace }: { workspace: ReturnType<typeof useWorkspace> }) {
  ...
  return <div className="student-page"><header className="student-header"><span className="auth-brand"><span><BookOpen size={21} /></span>AX <b>LearningOps</b></span><button className="button secondary" onClick={() => void logout()}><LogOut size={15} />로그아웃</button></header><main className="student-main">
