...
import { BookOpen, CheckCheck, ClipboardList, Users, GraduationCap, UserCheck } from 'lucide-react'
...
const pages: RolePage[] = [
  ...
  { id: 'admissions', name: '가입 승인', description: '담당 범위의 기존 가입 신청을 확인하세요.', icon: UserCheck },
