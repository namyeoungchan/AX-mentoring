...
export type Session = { id: string; title: string; mentor: string; mentorId?: string; studentId?: string; team: string; date: string; time: string; endDate?: string; endTime?: string; status: '승인 대기' | '예약 확정' | '완료' | '취소' }
