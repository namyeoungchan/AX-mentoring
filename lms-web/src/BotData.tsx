...
type State = { revision: string; guildIds: string[]; tables: { key: string; label: string; count: number }[]; imports: { checksum: string; guildId: string; state: string; error: string; createdAt: string }[]; settings: Settings[] }
...
const empty: State = { revision: '', guildIds: [], tables: [], imports: [], settings: [] }
